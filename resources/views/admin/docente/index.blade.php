            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de docentes</h5>
                            </div>
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <a href="{{route('docente.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de docentes -->
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        ...
        function search() {
            ...
            const ruta = route('docente.search');
        ...
        function modalCrear() {
            const ruta = route("docente.create");
        ...
        function guardar() {
            const ruta = route('docente.store');
        ...
        function modalEditar(id) {
            const ruta = route('docente.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('docente.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('docente.destroy', [id]);
