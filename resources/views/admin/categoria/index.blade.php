            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <a href="{{route('categoria.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de categoria-->
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        ...
        function modalEditar(id) {
            ...
            const ruta = route('categoria.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('categoria.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('categoria.destroy', [id]);
