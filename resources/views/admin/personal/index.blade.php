            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de personal</h5>
                            </div>
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <a href="{{route('personal.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de personals -->
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        ...
        function search() {
            ...
            const ruta = route('personal.search');
        ...
        function modalCrear() {
            const ruta = route("personal.create");
        ...
        function guardar() {
            const ruta = route('personal.store');
        ...
        function modalEditar(id) {
            const ruta = route('personal.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('personal.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('personal.destroy', [id]);
