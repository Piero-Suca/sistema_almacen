            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de entradas</h5>
                            </div>
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <a href="{{route('entrada.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de entradas -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
          ...
          function search() {
            ...
            const ruta = route('entrada.search');
        ...
        function modalCrear() {
            const ruta = route("entrada.create");
        ...
        function guardar() {
            const ruta = route('entrada.store');
        ...
        function modalEditar(id) {
            ...
            const ruta = route('entrada.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('entrada.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('entrada.destroy', [id]);
