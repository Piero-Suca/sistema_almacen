    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">especialiadads</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <a href="{{route('especialidad.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de especialidad-->
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
          ...
          function search() {
            ...
            const ruta = route('especialidad.search');
        ...
        function modalCrear() {
            const ruta = route("especialidad.create");
        ...
        function guardar() {
            const ruta = route('especialidad.store');
        ...
        function modalEditar(id) {
            ...
            const ruta = route('especialidad.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('especialidad.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('especialidad.destroy', [id]);
